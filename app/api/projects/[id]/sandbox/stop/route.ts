...
export async function POST(
  ...
  try {
    ...
    console.log(`🔧 Attempting to stop sandbox - Project ID: ${project.id}, Project Name: ${project.name}, Namespace: ${k8sNamespace}`);
    await k8sService.stopSandbox(project.name, k8sNamespace);
